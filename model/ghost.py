...
class GhostNet(nn.Module):
    def __init__(self, input_size, emb_size = 512,nb_ch=3, width=1.3):
        ...
        self.conv_stem = nn.Conv2d(nb_ch, output_channel, 3, 1, 1, bias=False)
        ...
        self.output_layer = GDC(664, emb_size)
