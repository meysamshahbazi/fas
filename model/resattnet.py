...
class Backbone_56(nn.Module):
    # for input size 112
    def __init__(self, input_size, num_layers,emb_size=512,nb_ch=3, mode='ir'):
        ...
        if mode == 'ir':
            ...
            ResidualBlock = bottleneck_IR_SE
        self.input_layer = nn.Sequential(nn.Conv2d(nb_ch, 64, (3, 3), 1, 1, bias=False),
                                      nn.BatchNorm2d(64),
                                      nn.PReLU(64))
...
def AttentionNet_IR_56(input_size=[112,112],emb_size=512,nb_ch=3):
    """Constructs a AttentionNet_IR_56 model.
    """
    model = Backbone_56(input_size, 56, mode='ir',emb_size= emb_size,nb_ch=nb_ch)
    return model

def AttentionNet_IRSE_56(input_size=[112,112],emb_size=512,nb_ch=3):
    """Constructs a AttentionNet_IRSE_56 model.
    """
    model = Backbone_56(input_size, 56, mode='ir_se',emb_size= emb_size,nb_ch=nb_ch)
    return model

def AttentionNet_IR_92(input_size=[112,112],emb_size=512,nb_ch=3):
    """Constructs a AttentionNet_IR_92 model.
    """
    model = Backbone_92(input_size, 92, mode='ir',emb_size= emb_size,nb_ch=nb_ch)
    return model

def AttentionNet_IRSE_92(input_size=[112,112],emb_size=512,nb_ch=3):
    """Constructs a AttentionNet_IRSE_92 model.
    """
    model = Backbone_92(input_size, 92, mode='ir_se',emb_size= emb_size,nb_ch=nb_ch)
    return model
